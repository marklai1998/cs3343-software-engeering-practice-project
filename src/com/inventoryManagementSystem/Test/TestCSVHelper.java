...
public class TestCSVHelper {
	...
	public void testGetCsvBuffer_01() {
		String path = "/com/inventoryManagementSystem/Data/staff.csv";
		...
		String[] matcher1 = { "0", "user", "user", "0" };
		String[] matcher2 = { "1", "user2", "user2", "1" };
		String[] matcher3 = { "2", "user3", "user3", "2" };
		String[] matcher4 = { "3", "user4", "user4", "3" };
...
//	@Test
//	public void testGetCsvBuffer_03() {
//		String path = "/com/inventoryManagementSystem/Data/emptyCSVHelper_01.csv";
//
//		CSVHelper csvHelper = new CSVHelper(path);
//
//		ArrayList<String[]> result = csvHelper.getCsvBuffer();	
